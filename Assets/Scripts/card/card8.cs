...
public class card8 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        a = me.GetComponent<PlayerState>().atk + 2;
    ...
    public void ActivateEffect(GameObject target)
    {
        ...
        {
            a = opp.GetComponent<PlayerState>().atk + 2;
        }

...
public class card14 : MonoBehaviour
{
    ...
    public void ActivateEffect(GameObject target)
    {
        ...
        {
            opp.GetComponent<PlayerState>().maxcost += 1;
            opp.GetComponent<PlayerState>().hp -= 2;
        }
        else
        {
            me.GetComponent<PlayerState>().maxcost += 1;
            me.GetComponent<PlayerState>().hp -= 2;
        }

...
public class card9 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        a = me.GetComponent<PlayerState>().atk + 18;
    ...
    public void ActivateEffect(GameObject target)
    {
        ...
        {
            a = opp.GetComponent<PlayerState>().atk + 18;
        }
